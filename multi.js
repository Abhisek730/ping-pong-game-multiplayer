...
const leftCom = document.getElementById("leftcom");
const rightCom = document.getElementById("rightcom");
...
function update(){
    ...
    // let userputerLevel = 0.1
    // user.x += (ball.x - (user.x + user.width/2)) + userputerLevel;
    // if(ball.speed > 2){
    //     user.x =+ ball.x + 100
    // }
